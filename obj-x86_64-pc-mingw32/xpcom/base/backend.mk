...
CPPSRCS += nsDebugImpl.cpp

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_xpcom_base0.cpp Unified_cpp_xpcom_base1.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
NO_PROFILE_GUIDED_OPTIMIZE += c:/Work/PaleMoon/White-Star/platform/xpcom/base/nsDebugImpl.cpp
RTL_FLAGS += -MD
LIBRARY_NAME := xpcom_base
FORCE_STATIC_LIB := 1
REAL_LIBRARY := xpcom_base.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
