...
UNIFIED_CPPSRCS := Unified_cpp_components_alerts0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
JAR_MANIFEST := c:/Work/PaleMoon/White-Star/platform/toolkit/components/alerts/jar.mn
RTL_FLAGS += -MD
LIBRARY_NAME := toolkit_components_alerts
FORCE_STATIC_LIB := 1
REAL_LIBRARY := toolkit_components_alerts.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
