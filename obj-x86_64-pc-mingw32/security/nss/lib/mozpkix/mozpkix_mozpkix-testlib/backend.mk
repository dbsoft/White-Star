...
CPPSRCS += test-lib/pkixtestalg.cpp
CPPSRCS += test-lib/pkixtestnss.cpp
CPPSRCS += test-lib/pkixtestutil.cpp
...
RTL_FLAGS += -MD
VISIBILITY_FLAGS := 
LIBRARY_NAME := mozpkix-testlib
FORCE_STATIC_LIB := 1
REAL_LIBRARY := mozpkix-testlib.lib
