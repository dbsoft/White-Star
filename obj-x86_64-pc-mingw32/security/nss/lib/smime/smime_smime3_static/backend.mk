...
RTL_FLAGS += -MD
VISIBILITY_FLAGS := 
LIBRARY_NAME := smime3_static
FORCE_STATIC_LIB := 1
REAL_LIBRARY := smime3_static.lib
STATIC_LIBS += $(DEPTH)/security/nss/lib/pkcs12/pkcs12_pkcs12/pkcs12.lib
STATIC_LIBS += $(DEPTH)/security/nss/lib/pkcs7/pkcs7_pkcs7/pkcs7.lib
STATIC_LIBS += $(DEPTH)/security/nss/lib/smime/smime_smime/smime.lib
