...
CPPSRCS += nsAboutBlank.cpp
CPPSRCS += nsAboutCache.cpp
CPPSRCS += nsAboutCacheEntry.cpp
CPPSRCS += nsAboutProtocolHandler.cpp
RTL_FLAGS += -MD
LIBRARY_NAME := netwerk_protocol_about
FORCE_STATIC_LIB := 1
REAL_LIBRARY := netwerk_protocol_about.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
