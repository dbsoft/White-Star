...
CPPSRCS += nsJAR.cpp
CPPSRCS += nsJARChannel.cpp
CPPSRCS += nsJARFactory.cpp
CPPSRCS += nsJARInputStream.cpp
CPPSRCS += nsZipArchive.cpp

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_modules_libjar0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
RTL_FLAGS += -MD
LIBRARY_NAME := modules_libjar
FORCE_STATIC_LIB := 1
REAL_LIBRARY := modules_libjar.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
