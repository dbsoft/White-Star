...
UNIFIED_CPPSRCS := Unified_cpp_dom_notification0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
misc::
	$(call py_action,buildlist,$(DEPTH)/dist/bin/chrome.manifest 'manifest components/NotificationStorage.manifest')
RTL_FLAGS += -MD
LIBRARY_NAME := dom_notification
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_notification.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
