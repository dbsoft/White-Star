...
CPPSRCS += ModuleLoadRequest.cpp
CPPSRCS += ModuleScript.cpp
CPPSRCS += ScriptElement.cpp
CPPSRCS += ScriptLoadHandler.cpp
CPPSRCS += ScriptLoader.cpp
CPPSRCS += ScriptSettings.cpp
RTL_FLAGS += -MD
LIBRARY_NAME := dom_script
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_script.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
