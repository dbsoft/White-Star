...
LOCAL_INCLUDES += -I$(topsrcdir)/dom/settings
...
CPPSRCS += EventStateManager.cpp

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_dom_events0.cpp Unified_cpp_dom_events1.cpp Unified_cpp_dom_events2.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
RTL_FLAGS += -MD
LIBRARY_NAME := dom_events
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_events.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
