...
misc::
	$(call py_action,buildlist,$(DEPTH)/dist/bin/chrome.manifest 'manifest components/DOMSecureElement.manifest')
RTL_FLAGS += -MD
LIBRARY_NAME := dom_secureelement
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_secureelement.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
