...
UNIFIED_CPPSRCS := Unified_cpp_media_platforms_omx0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
MOZBUILD_CXXFLAGS += -validate-charset-
RTL_FLAGS += -MD
LIBRARY_NAME := dom_media_platforms_omx
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_media_platforms_omx.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
