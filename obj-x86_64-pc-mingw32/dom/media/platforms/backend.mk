...
DIRS := agnostic/gmp omx wmf ffmpeg/ffvpx
...
UNIFIED_CPPSRCS := Unified_cpp_dom_media_platforms0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
RTL_FLAGS += -MD
LIBRARY_NAME := dom_media_platforms
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_media_platforms.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
