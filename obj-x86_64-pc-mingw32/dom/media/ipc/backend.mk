...
CPPSRCS += RemoteVideoDecoder.cpp
CPPSRCS += VideoDecoderChild.cpp
CPPSRCS += VideoDecoderManagerChild.cpp
CPPSRCS += VideoDecoderManagerParent.cpp
CPPSRCS += VideoDecoderParent.cpp
RTL_FLAGS += -MD
LIBRARY_NAME := dom_media_ipc
FORCE_STATIC_LIB := 1
REAL_LIBRARY := dom_media_ipc.lib
OS_LIBS += psapi.lib
OS_LIBS += shell32.lib
OS_LIBS += dbghelp.lib
