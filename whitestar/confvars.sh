...
# to "White Star" and "DBSoft" respectively for White Star
...
MOZ_BRANDING_DIRECTORY=whitestar/branding/unofficial
MOZ_OFFICIAL_BRANDING_DIRECTORY=whitestar/branding/official
